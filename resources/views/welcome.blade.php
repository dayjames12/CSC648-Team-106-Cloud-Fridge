        ...
        <article class="message">
            ...
            <div class="message-body">
                ...
                <div class="box">
                    ...
                    <div class="content">Met in class to discuss Project. Our group decided to start a different Framework called Laravel. This is a risk because our team members needs to relearn a new Framework and need to worry if we could turn our project on time. Laravel was not familiar with everybody in our group and we had difficulties with getting everything installed into our Machine. Those members of our team who had Mac books had some difficulties. Those members who have Macbook that figure out the solution about Laravel helped those students who are struggling with MacBook.</div>
                </div>

                <div class="box">
                    <h5 class="title is-5">10/17/19</h5>
                    <div class="content">We met In-class to discuss about project. All risk in our group still have trouble using Laravel. Some members need to install composer and Laravel to start running this Framework. This risk is important because the due date is coming soon and not all students have gotten the Framework into their computer yet. We resolve this problem by providing online resources on our online group chat called Discord so all members can get help when they are away.</div>
                </div>

                <div class="box">
                    <h5 class="title is-5">10/22/19</h5>
                    <div class="content">During our In-class and after-Class meeting, we all spent time working on our group project together. The risk that we have was we are missing our group leader and there are some important information that we need to tell him that our professor had told us. This is a risk because our group hopes to have everybody to get the right message heard and understand what needed to be done for this project. We resolve this issue by our group members who was present reach out to our leader to let him know what was discussed by the professor.</div>
                </div>

                <div class="box">
                    <h5 class="title is-5">10/29/19</h5>
                    <div class="content">Met during last part of class. The risk are some members aren't present to work on the project together and wasn't able to communicated the full message to them. We resort to communicated to the students who didn't show up through Discord (Messaging Application). Project milestone 3 is due next week and the risk was don't know if everybody who didn't show up got the message on if members got their parts accomplished.</div>
                </div>
                ...
                <div class="box">
                    ...
                    <div class="content">
                    There are some of our teams members who decide to come together to work on the project today. Some team members wanted to met in person to work on the project because we felt that by coming together in person really help on improving the progress of our project. Although most of us where coding, we thought this moment is another great moment for us to bond because we get to know our team members throughout this semester and it was great to talk to our other team members while not worry about class work. Even though this is a Software Engineering course, this project showed us how to work with other people in a team and that
