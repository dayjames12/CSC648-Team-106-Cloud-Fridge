...
<section class="hero is-primary">
  ...
  <div class="block">
    <article class="message">
      <div class="message-header">
        <p>Recorded Meeting Summary</p>
      </div>

      <div class="message-body">
        <table style="width:100%" border="1">
          <caption><strong>Logged Meeting Summary</strong></caption>
          <tr>
            <th>Date:</th>
            <th>Students Present:</th>
            <th>Length of Time + Location of Meeting:</th>
            <th>Risks:</th>
          </tr>
          ...
          <tr>
            <td>September 25</td>
            <td>George Butler, James Day, Sydni Starling, Jian Xin Qi, Raymond Gee, Aung Hein, Tommy Nguyen</td>
            <td>1 hour & 15 Minutes (In class)</td>
            <td>
          ...
          <tr>
            <td>October 22</td>
            <td>James Day, Sydni Starling, Jian Xin Qi, Raymond Gee, Aung Hein, Tommy Nguyen</td>
            <td>1 hour & 40 Minutes (During and After Class)</td>
            <td>
